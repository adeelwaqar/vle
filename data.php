...
$sql = "SELECT kin_evidences.activitytype , COUNT(kin_evidences.activitytype) FROM `kin_evidences` WHERE `activitychildren` like '%TARA%' OR `activitychildren` = 'All' Group BY activitytype";
